// Service worker — Punto Queso Catálogo (public order page)
...
const CACHE_NAME = 'pq-catalogo-shell-v1';
...
self.addEventListener('fetch', (event) => {
  ...
  // API calls (PostgREST, MercadoPago, etc.), non-GET requests, and
  // cross-origin requests all pass straight through to network.
